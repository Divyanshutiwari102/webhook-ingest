...
func main() {
	...
	// Wait for background recording processing to complete with a timeout.
	if err := svc.WaitTimeout(shutdownTimeout); err != nil {
		log.Error("timeout waiting for background work", "err", err)
	}
}
